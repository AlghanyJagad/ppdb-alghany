									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="profile.php?id=<?php echo $r['id']; ?>">Lihat Selengkapnya</a></td>
												<td><a href="edit.php?id=<?php echo $r['id']; ?>">Edit</td>
												<td><a href="delete.php?id=<?php echo $r['id']; ?>" onClick="return confirm('Hapus data ?')">Hapus</a></td>
											</tr>
										<?php } ?>
										</tbody>
									</table>
